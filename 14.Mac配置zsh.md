...
- [1.修改zsh作为默认shell](#1修改zsh作为默认shell)
- [2.安装oh-my-zsh](#2安装oh-my-zsh)
- [3.配置plugins](#3配置plugins)
- [4.zsh主题介绍](#4zsh主题介绍)
- [5.zsh插件介绍](#5zsh插件介绍)
- [6.常见问题](#6常见问题)
- [7.zshrc](#7zshrc)
...
## 4.[zsh主题介绍](https://github.com/ohmyzsh/ohmyzsh/wiki/themes)



## 5.[zsh插件介绍](https://github.com/ohmyzsh/ohmyzsh/wiki/Plugins)
